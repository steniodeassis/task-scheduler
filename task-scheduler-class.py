...
tasks1 = [
    Task(id=0, description='waking up', expected_start=7*60, duration=10, dependencies=[], fixed=False), 
    Task(id=1, description='take shower', expected_start=8*60, duration=30, dependencies=[0], fixed=False),
    Task(id=2, description='eat breakfast', expected_start=(8*60)+45, duration=45, dependencies=[0], fixed=False),
    Task(id=3, description='study for CS110', expected_start=10*60, duration=300, dependencies=[0, 2], fixed=True),
    Task(id=4, description='take CS110 class', expected_start=14*60, duration=100, dependencies=[0, 3], fixed=True),
    Task(id=5, description='bird watching fair', expected_start=16*60, duration=120, dependencies=[0], fixed=True),
    Task(id=6, description='meet local friend', expected_start=18*60, duration=30, dependencies=[0], fixed=True),
    Task(id=7, description='night market', expected_start=19*60, duration=120, dependencies=[0, 6], fixed=True),
...
assert(task_scheduler1.run_scheduler() == task_scheduler2.run_scheduler())
